...
type ProxyStatistics struct {
	...
	UserId            int `xorm:"not null default 0 comment('用户编号') INT(10)"`
	ParentId          int `xorm:"not null default 0 comment('父级编号') INT(10)"`
	Level             int `xorm:"not null default 0 comment('层级') INT(10)"`
