...
var notices = models.Notices{}                          //模型
var noticesValidation = validations.NoticesValidation{} //校验器

type NoticesController struct{}

/**
 * @api {get} admin/api/auth/v1/notices 站内公告列表
 * @apiDescription
 * <span style="color:lightcoral;">接口负责人: juzi</span><br/><br/>
 * <strong>站内公告列表</strong><br />
 * 业务描述: 站内公告列表</br>
 * @apiVersion 1.0.0
 * @apiName     indexNotices
 * @apiGroup    content
 * @apiPermission PC客户端
 ...
 * @apiSuccess (data-rows每个子对象字段说明) {string}     title			公告标题
 ...
 * @apiSuccess (data-rows每个子对象字段说明) {string}		status		状态
 *
 ...
 * }
 */
func (self *NoticesController) Index(ctx *Context) {
	index(ctx, &notices)
}

/**
 * @api {post} admin/api/auth/v1/notices/add	站内公告添加
 * @apiDescription
 * <span style="color:lightcoral;">接口负责人: juzi</span><br/><br/>
 * <strong>添加/修改站内公告</strong><br />
 * 业务描述: 添加/修改站内公告 <br />
 * <strong><span style="color: red">注意: </span></strong><br />
 * <span style="color:red">修改操作API不再单独列出, 请参考以下</span><br />
 * <span style="color:red">添加: /admin/api/auth/v1/notices/add </span> &nbsp;&nbsp; <br />
 * <span style="color:red">修改: /admin/api/auth/v1/notices/update </span>
 * @apiVersion 1.0.0
 * @apiName     saveNotices
 * @apiGroup    content
 * @apiPermission PC客户端
 ...
 * @apiParam (客户端请求参数) {int} 	id    					记录编号,仅修改操作时(即接口: /admin/api/auth/v1/notices/update)需要<br />
 *															添加操作(即接口: /admin/api/auth/v1/notices/add)不需要此参数<br />
 * 															* 如果提供此编号, 则视为修改记录
 ...
 * }
 */
func (self *NoticesController) Save(ctx *Context) {
	save(ctx, &notices, &noticesValidation)
}

/**
 * @api {get} admin/api/auth/v1/notices/view 				站内公告详情
 * @apiDescription
 * <span style="color:lightcoral;">接口负责人: juzi</span><br/><br/>
 * <strong>站内公告详情</strong><br />
 * 业务描述: 站内公告详情</br>
 * @apiVersion 1.0.0
 * @apiName     viewNotices
 * @apiGroup    content
 ...
 * }
 */
func (self *NoticesController) View(ctx *Context) {
	view(ctx, &notices)
}

/**
 * @api {get} admin/api/auth/v1/notices/delete 站内公告删除
 * @apiDescription
 * <span style="color:lightcoral;">接口负责人: juzi</span><br/><br/>
 * <strong>站内公告删除</strong><br />
 * 业务描述: 站内公告删除</br>
 * @apiVersion 1.0.0
 ...
 * }
 */
func (self *NoticesController) Delete(ctx *Context) {
	remove(ctx, &notices)
}
