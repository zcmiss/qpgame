...
var silverMerchantCapitalFlows = models.SilverMerchantCapitalFlows{}
var silverMerchantCapitalFlowsValidation = validations.SilverMerchantCapitalFlowsValidation{}

type SilverMerchantCapitalFlowsController struct{}

/**
 * @api {get} admin/api/auth/v1/silver_merchant_capital_flows 银商流水记录
 * @apiDescription
 * <span style="color:lightcoral;">接口负责人: lyndon</span><br/><br/>
 * <strong>银商流水记录</strong><br />
 * 业务描述: 银商流水记录</br>
 * @apiVersion 1.0.0
 * @apiName     indexSilverMerchantCapitalFlows
 ...
 * @apiParam (客户端请求参数) {int} 	 type           流水类型，1额度充值，2会员充值扣款
 ...
 * @apiSuccess (data-rows每个子对象字段说明) {int}     type               流水类型，1额度充值，2会员充值扣款
 ...
 *}
 */
func (self *SilverMerchantCapitalFlowsController) Index(ctx *Context) {
	index(ctx, &silverMerchantCapitalFlows)
}
