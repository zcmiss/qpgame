...
var silverMerchantOsLogs = models.SilverMerchantOsLogs{}
var silverMerchantOsLogsValidation = validations.SilverMerchantOsLogsValidation{}

type SilverMerchantOsLogsController struct{}

/**
 * @api {get} admin/api/auth/v1/silver_merchant_os_logs 银商操作记录
 * @apiDescription
 * <span style="color:lightcoral;">接口负责人: lyndon</span><br/><br/>
 * <strong>银商操作记录记录</strong><br />
 * 业务描述: 银商操作记录记录</br>
 * @apiVersion 1.0.0
 * @apiName     indexSilverMerchantOsLogs
 ...
 * @apiParam (客户端请求参数) {string} 	city          所在城市
 ...
 * @apiSuccess (data-rows每个子对象字段说明) {string}   city          所在城市
 ...
 * }
 */
func (self *SilverMerchantOsLogsController) Index(ctx *Context) {
	index(ctx, &silverMerchantOsLogs)
}
